...
(function () {
  ...
  if (!__l) { return; }
    var _ctx__loopcache08206943238001962 = { loop: _ctx.loop, color: _ctx.color, __k: _ctx.__k };
...
_output += "</li>\n            ";
  ...
  _ctx.loop = _ctx__loopcache08206943238001962.loop;
  _ctx.color = _ctx__loopcache08206943238001962.color;
  _ctx.__k = _ctx__loopcache08206943238001962.__k;
  _ctx__loopcache08206943238001962 = undefined;
})();
_output += "\n        </ul>\n        ";
} else {
_output += "\n        <div>\n            No colors!\n        </div>\n        ";
